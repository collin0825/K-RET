...
def generate_output(log_file, test_file, output_file):
	...
	for line_number, element in enumerate(predictive_classes):
		...
		out_file.write(pair_type_to_label[predictive_classes[line_number]] + '\t' + dataset_lines[line_number] + '\t' + pair_type_to_label[ori_classes[line_number]] +'\n')
