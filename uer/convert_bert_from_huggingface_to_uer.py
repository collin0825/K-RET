...
def main():
    ...
    # python convert_bert_from_huggingface_to_uer.py --input_model_path pytorch_model.bin --output_model_path ../models/medbert/output_model.bin
    # python convert_bert_from_huggingface_to_uer.py --input_model_path pytorch_model.bin --output_model_path ../models/Pubmedbert/output_model.bin
